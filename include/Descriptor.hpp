 ...
 */
 ...
 private:
         ...
         SegmentDescriptor kernelcodeSegmentSelector;
         SegmentDescriptor kerneldataSegmentSelector;
         ...
         GlobalDescriptorTable(const GlobalDescriptorTable&&){}
         GlobalDescriptorTable& operator=(const GlobalDescriptorTable&){}
         GlobalDescriptorTable& operator=(const GlobalDescriptorTable&&){}
         ~GlobalDescriptorTable();

         const static GlobalDescriptorTable* object;
     public:
